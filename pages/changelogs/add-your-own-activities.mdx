...
The type field within activities is a defining factor for rendering. For instance, when the _type_ is set to _star_, and the platform is GitHub, the activity is described as _starred [crowd.dev](https://github.com/CrowdDotDev/crowd.dev)_.
...
This enhancement opens the door for two significant use cases: crafting activities manually and adding activities via API.

## Add activities manually

You can now create activities manually, which is useful when you want to record one-off activities, such as a member speaking at a conference or writing a blog post about your product.
...
It can also help you sync data from external sources, such as spreadsheets or databases.
