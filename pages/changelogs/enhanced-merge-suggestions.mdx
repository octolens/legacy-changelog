...
- Introduced multiple member identities for a single platform for improved merging. <PullRequest number="787"/>
- Enhanced merge suggestions with the addition of confidence scoring. <PullRequest number="797"/>
- Added a column to display the number of activities for all member views. <PullRequest number="789"/>
